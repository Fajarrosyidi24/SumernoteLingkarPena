        ...
        <div>
            ...
            <AuthenticatedLayout>
                <div className="container mt-4">
                    <h1 className="mb-4">Daftar Artikel</h1>
                    ...
                    <Link href={route('artikels.create')} className="btn btn-sm-primary mb-4">
                        <i className="bi bi-plus-circle me-1 fs-5"></i> Tambah Artikel
                    </Link>
